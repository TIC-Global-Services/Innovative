        ...
        <div className="relative px-4 w-full rounded-lg overflow-hidden h-[400px] md:h-[400px] lg:h-[500px] mb-8">
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 p-6">
            <div className="max-w-[1200px] ">
              <h1 className="text-xl sm:text-2xl md:text-[35px] text-white font-medium leading-tight">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl font-normal text-white leading-normal mt-2 md:w-[50%]">
                We source materials in bulk for large-scale production and
                on-site execution — ensuring consistency, speed, and
                reliability.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 gap-8  w-full">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl sm:text-2xl md:text-[35px] text-[#040444] font-medium leading-tight">
                Iconic Projects, Meaningful Impact
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-[20px] text-[#141414] font-normal mt-2">
                Collaborate on high-value interiors across luxury residential,
